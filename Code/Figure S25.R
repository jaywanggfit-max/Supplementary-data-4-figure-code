...
figure_id <- "Supplementary_Fig_25"
figure_title <- "Flagellar structural Orthogroups (55 MPa Droplet vs 0.1 MPa Droplet)"
output_svg_name <- "Supplementary_Fig_25.svg"
output_png_name <- "Supplementary_Fig_25.png"
expected_contrast <- "D55_vs_D0"
expected_contrast_label <- "55D vs 0.1D"
width_mm <- 219.2
height_mm <- 106.8
width_px <- 2067
height_px <- 1007
...
make_title_panel <- function(title) {
  ggplot() +
    ...
    annotate("text", x = -0.12, y = 0.51, label = title, family = base_family,
             hjust = 0, size = 3.65, colour = axis_col) +
